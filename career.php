...
<body>
  ...
  <section class="section-padding">
    <div class="container">
      <h3 class="inner-sub-heading text-center aos-animate" data-aos="fade-up" data-aos-duration="1000">
        Hello, <span> We Are</span> Hiring     
      </h3>
  ...
  push your expertise to new heights, we invite to join hands.
      ...
      <div class="row mt-5 aos-animate" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="career-box">
          <h3>01</h3>
          <h4>Application</h4>
          <p class="career-para">Our user-friendly career section enables you to apply for the desired job. Submit your resume with a complete list of credentials and provide detailed information about your experience for the position applied.</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="career-box">
      ...
      <div class="container">
        ...
        <p class="main-para text-center aos-animate" data-aos="fade-up" data-aos-duration="1000">Find the role that fits.</p>
          ...
          <div class="apply-box aos-animate" data-aos="fade-up" data-aos-duration="1000">
            <div class="row d-flex align-items-center">
              <div class="col-lg-5">
                <h4 class="job-title">Production Manager (Events)</h4>
          ...
          <div class="apply-box aos-animate" data-aos="fade-up" data-aos-duration="1000">
            <div class="row d-flex align-items-center">
              <div class="col-lg-5">
                <h4 class="job-title">Business Development Manager</h4>
