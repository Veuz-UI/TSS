        ...
        <div class="row">
          <div class="col-lg-8 d-flex align-items-center">
            <div class="client-detail-div">
              ...
              <div class="d-flex align-items-center client-detail-cntnt"> 
                <img src="img/event-location.svg" alt="" class="img-fluid">
                <h6>Akshya Nagar 1st Block 1st Cross, Rammurthy nagar, Saudi Arabia-560016 <span>Get Directions</span></h6>
              </div>
              <div class="d-flex align-items-center client-detail-cntnt"> 
              ...
              <div class="d-flex align-items-center client-detail-cntnt"> 
                ...
                <h6>3.6 (15 Ratings) • Trade Show</h6>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d31304.793987226316!2d75.81628693476561!3d11.254109000000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1701947287913!5m2!1sen!2sin" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
      </div>
      
      <div class="event-catogery-box event-main-div">
        <ul class="nav nav-tabs evnt-dtl-tab mb-3 d-flex justify-content-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" id="ex1" role="tablist">
          <li class="nav-item portfolio-tab" role="presentation">
            <a class="nav-link active" id="ex1-tab-1" data-bs-toggle="tab" href="#ex1-tabs-1" role="tab" aria-controls="ex1-tabs-1" aria-selected="true">About</a>
          </li>
          <li class="nav-item portfolio-tab" role="presentation">
            <a class="nav-link" id="ex1-tab-2" data-bs-toggle="tab" href="#ex1-tabs-2" role="tab" aria-controls="ex1-tabs-2" aria-selected="false">Feed</a>
          </li>
          <li class="nav-item portfolio-tab" role="presentation">
            <a class="nav-link" id="ex1-tab-3" data-bs-toggle="tab" href="#ex1-tabs-3" role="tab" aria-controls="ex1-tabs-3" aria-selected="false">656 Exhibitors</a>
          </li>
          <li class="nav-item portfolio-tab" role="presentation">
            <a class="nav-link" id="ex1-tab-4" data-bs-toggle="tab" href="#ex1-tabs-4" role="tab" aria-controls="ex1-tabs-4" aria-selected="false">8 Reviews</a>
          </li>
        </ul>
        <div class="tab-content" id="ex1-content">
          <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
            <div class="client-detail-div">
              <h4 class="event-detail-heading">Unwavering commitment to your success</h4>
              <p class="main-para">
                TSS Advertising Company has its roots all over the GCC and has grown to dominance over the years with a vision to be a leader globally in the businesses we operate by empowering our customers and enriching the lives of people, and with a mission meant to provide solutions to empower and enrich people and organizations
              </p>
              <div class="row">
                <div class="col-lg-3">
                  <div class="event-dtl-images">
              ...
              <div class="row mt-3">
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                    <h4>Timing</h4>
                    <h6>10:00 AM -6:00 PM(Bussines)</h6>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                    <h4> Entry Fee</h4>
                    <h6>Free Ticket For Industry Professionals Exhibit Booth
                      Cost Starts from 651 USD</h6>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                ...
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                    ...
                    <a href="event-listing.php">
                      <button class="event-catogery-btn" type="button">+8 more editions</button>
                    </a>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <button class="ofcil-link-btn ml-5" type="button">
                        <span>
                          <img src="img/call-red.svg" alt="">
                        </span>
                        Website
                      </button>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="event-detail-subboxes">
                    <h4>Eco Expo Asia</h4>
                    <h6>26 - 29 Oct 2023</h6>
                    <h6 class="mt-1">102 Followers</h6>
                  </div>
                </div>
