...
<h3 class="side-nav-head">Business Enquiry</h3>
<div class="row">
<div class="col-lg-12">
...
<div class="col-lg-6">
  <div class="input-container">
    <input placeholder="Contact Number" class="input-field" type="text">
  ...
  <div class="col-lg-6">
    <div class="input-container">
      <input placeholder="Email Address" class="input-field" type="text">
    ...
    <div class="col-lg-6">
      <div class="input-container">
        <select class="side-select" name="cars" id="cars">
          <option value="0" label="Select a country ... " selected="selected">Region / Country</option>
      ...
      <div class="col-lg-6">
        <div class="input-container">
          <select class="side-select sccope-work" name="cars" id="cars">
            <option>Scope of Work</option>
                <option value="1">Events</option>
                <option value="2">Branding</option>
                <option value="3">Booths</option>
        ...
        <div class="col-lg-12" id="hidden_div" style="display: none;">
          <div class="input-container">
            <input placeholder="Type here" class="input-field" type="text">
            <label for="input-field" class="input-label">Type Here</label>
            <span class="input-highlight"></span>
          </div>
          </div>
        <div class="col-lg-12">
